...
func NewStorage(params Params, altHost, altPort string) (*Storage, error) {
	db, err := newDatabase(params.Username, params.Password, params.DBName, params.Address, params.Port, altHost, altPort)
	storage := &Storage{db}
	return storage, err
}
